...
public class ToolsQaExample extends CommonMethods{
	...
	public void getData(String first , String last , String date) { // # of values passed by DP m() should be equal to # of attributes of test method on which DataProvider method is used
